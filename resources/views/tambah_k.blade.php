                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <h3 style="margin-left: 20px;"><span><p align="center" style="">Sistem Pemilihan Calon Peserta Olimpiade MIPA SDN 2 Melayu</p> </span></h3>
                        </div>
                    </div>
                </div>
            </header>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Data Kriteria</strong> Form
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="/add_k" method="post" class="form-horizontal">
                                            @csrf
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="kode" name="kode" placeholder="" class="form-control" value="{{$kode}}">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="nama" name="nama" placeholder="Input Nama Kriteria" class="form-control" required="" pattern="[A-z\s]+">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="bobot" name="bobot" placeholder="Input Bobot Kriteria" class="form-control" required="" min="0" max="100">
                                                    <!-- <span class="help-block">Please enter your email</span> -->
                                                </div>
                                            </div>
                                    </div>
