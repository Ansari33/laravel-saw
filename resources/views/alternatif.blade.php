                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row m-t-30">
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="/tambah_a" class="btn btn-primary btn-sm" style="margin-bottom: 10px;">
                                            <i class="fa fa-plus"></i>&nbsp; Tambah Alternatif</a>
                                            <br>
                                <!-- DATA TABLE-->
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="/edit_a/{{$d2->id}}" class="btn btn-warning btn-sm">
                                            <i class="fa fa-edit"></i>&nbsp; Edit</a>
                                            <a href="/hapus_a/{{$d2->id}}" class="btn btn-danger btn-sm">
